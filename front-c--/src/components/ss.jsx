...
import { preRequestFormChecker } from "../Auth/preRequestCheck";
...
function Profile() {
  ...
  const handleSaveClick = () => {
    const { email, newPassword, firstName, lastName, dateOfBirth } = formData;
  ...
  return (
    <>
      ...
      <div className={profilesettingStyles.formContainerBackrgound_first}>
        ...
        <Link to="/confirm" className={profilesettingStyles.linkToConfirm}>
          confirm
        </Link>
...
import { Link } from "react-router-dom";
import { preRequestFormChecker } from "..components/Auth/preRequestCheck.js";
import profilesettingStyles from "../styles/Profile.module.css";
import toast, { Toaster } from "react-hot-toast";
...
import support from "../images/support.svg";
import exit from "../images/logout.png";
import {  validateEmail,  validatePassword,  validateName,  validateAge,} from "../components/FormValidtion's/validation's.js";
import EditProfileForm from "./EditProfileForm.jsx";
import ProfileInformation from "./ProfileInformation.jsx";
...
import axios from 'axios';
import { Link } from "react-router-dom";
import { preRequestFormChecker } from "../Auth/preRequestCheck.js";
import profilesettingStyles from "../../styles/Profile.module.css";
import toast, { Toaster } from "react-hot-toast";
